    ...
    content: (
      <div className="mt-1 flex flex-col gap-2">
        <div className="flex justify-between items-center bg-white/5 p-3 rounded-xl border border-white/10">
          <span className="text-[13px] text-white/50">Match Accuracy</span>
          <span className="text-[18px] font-bold text-purple-400">98.4%</span>
        </div>
      ...
      <div className="mt-1 flex flex-col gap-2">
        <div className="flex items-center gap-3">
          <div className="flex-1 h-3 bg-white/5 rounded-full overflow-hidden">
            <div className="w-3/4 h-full bg-blue-600 shadow-[0_0_12px_rgba(37,99,235,0.6)]" />
          </div>
          <span className="text-[12px] text-blue-400 font-bold whitespace-nowrap">12 Active</span>
        </div>
    ...
    content: (
      <div className="mt-1 space-y-2">
        <div className="flex items-center gap-2 animate-bounce">
          <div className="p-2 px-4 rounded-lg bg-amber-500 text-[13px] font-bold text-black flex items-center gap-2 shadow-[0_0_20px_rgba(245,158,11,0.4)]">
            <Bell className="w-4 h-4" /> New Opportunity
          </div>
        </div>
                ...
                <div className="magic-bento-card__top">
                  <div className="magic-bento-card__header">
                    <div 
                      ...
                      style={card.label === 'Dashboard' ? { color: '#fff', borderColor: 'rgba(255,255,255,0.2)', backgroundColor: 'rgba(255,255,255,0.08)' } : {}}
                    >
                      {card.label}
                    </div>

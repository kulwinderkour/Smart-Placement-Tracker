      ...
      >
        ...
        <div className="flex items-start gap-3 mb-5">
          ...
          <div>
            ...
            <p style={{ margin: '2px 0 0', fontSize: 13, color: '#6b7280', fontWeight: 400 }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            <span style={{ fontSize: 12.5, fontWeight: 500, color: '#6b7280' }}>Needs Improvement</span>
            <span style={{ fontSize: 12.5, fontWeight: 600, color: '#374151' }}>{skillPct}%</span>
          </div>
